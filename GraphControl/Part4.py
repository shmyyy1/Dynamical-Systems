...
fig_fold = '/Users/shamanth/Desktop/Important/Penn/GNN Lab-5/lab5_code_v2/figures_part4/'
...
#part3_folder_name = '/Users/shamanth/Desktop/Important/Penn/GNN Lab-5/experiments/flockingGNN-%03d-20251205193137'
#GraphNNs.saveDir = os.path.join('experiments', part3_folder_name)
#print(f"Loading model from: {GraphNNs.saveDir}")
#GraphNNs.load(label='Best')
